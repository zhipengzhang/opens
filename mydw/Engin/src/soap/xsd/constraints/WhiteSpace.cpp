...
#include "WhiteSpace.hpp"
    ...
    WhiteSpace::WhiteSpace():m_WhiteSpace(PRESERVE), m_Buf(NULL)
    {
		...
		if (axiscpp::AxisTrace::isTraceOn())
			axiscpp::AxisTrace::traceEntry("WhiteSpace", "WhiteSpace", this, 0);	  /* AUTOINSERTED TRACE */
	#endif
		...
		#ifdef ENABLE_AXISTRACE
			if (axiscpp::AxisTrace::isTraceOn())
				axiscpp::AxisTrace::traceExit("WhiteSpace", "WhiteSpace", this, 0);	  /* AUTOINSERTED TRACE */
		#endif
		return;
	}
}
	...
	#ifdef ENABLE_AXISTRACE
		if (axiscpp::AxisTrace::isTraceOn())
			axiscpp::AxisTrace::traceEntry("WhiteSpace", "WhiteSpace", this, 1,
					TRACETYPE_DATA, sizeof(whiteSpaceValue), ((void*)&whiteSpace));	  /* AUTOINSERTED TRACE */
	#endif
    ...
    const AxisString& WhiteSpace::replaceWhiteSpace(AxisString& value)
    {
	#ifdef ENABLE_AXISTRACE
		if (axiscpp::AxisTrace::isTraceOn())
			axiscpp::AxisTrace::traceEntry("WhiteSpace", "replaceWhiteSpace", this, 1,
        ...
        if (value.empty ())
        {
			...
			if (axiscpp::AxisTrace::isTraceOn())
				axiscpp::AxisTrace::traceExit("WhiteSpace", "replaceWhiteSpace", this, 1,
        ...
        if (AxisString::npos == nPos)
        {
			...
			const AxisString& traceRet = (value);
			if (axiscpp::AxisTrace::isTraceOn())
				axiscpp::AxisTrace::traceExit("WhiteSpace", "replaceWhiteSpace", this, 2,
					TRACETYPE_STLSTRING, 0, ((void*)&traceRet));	  /* AUTOINSERTED TRACE */
			return traceRet;
		#else
			return value;
        ...
        if (nLen > 0)
        {
			...
			if (axiscpp::AxisTrace::isTraceOn())
				axiscpp::AxisTrace::traceExit("WhiteSpace", "replaceWhiteSpace", this, 3,
					TRACETYPE_STLSTRING, 0, ((void*)&traceRet));	  /* AUTOINSERTED TRACE */
			return traceRet;
		#else
    ...
    const AxisString& WhiteSpace::stripLeadingWhiteSpace(AxisString& value)
    {
	#ifdef ENABLE_AXISTRACE
		if (axiscpp::AxisTrace::isTraceOn())
			axiscpp::AxisTrace::traceEntry("WhiteSpace", "stripLeadingWhiteSpace", this, 1,
					TRACETYPE_STLSTRING, 0, ((void*)&value));	  /* AUTOINSERTED TRACE */
	#endif
        ...
        while (value.size() > 0)
        {
			...
			const AxisString& traceRet = (value);
			if (axiscpp::AxisTrace::isTraceOn())
				axiscpp::AxisTrace::traceExit("WhiteSpace", "stripLeadingWhiteSpace", this, 0,
					TRACETYPE_STLSTRING, 0, ((void*)&traceRet));	  /* AUTOINSERTED TRACE */
			return traceRet;
		#else
			return value;
	...
	const AxisString& WhiteSpace::stripTrailingWhiteSpace(AxisString& value)
	{
	#ifdef ENABLE_AXISTRACE
		if (axiscpp::AxisTrace::isTraceOn())
			axiscpp::AxisTrace::traceEntry("WhiteSpace", "stripTrailingWhiteSpace", this, 1,
					TRACETYPE_STLSTRING, 0, ((void*)&value));	  /* AUTOINSERTED TRACE */
	#endif
		...
		while (value.size() > 0)
		{
			...
			const AxisString& traceRet = (value);
			if (axiscpp::AxisTrace::isTraceOn())
				axiscpp::AxisTrace::traceExit("WhiteSpace", "stripTrailingWhiteSpace", this, 0,
					TRACETYPE_STLSTRING, 0, ((void*)&traceRet));	  /* AUTOINSERTED TRACE */
			return traceRet;
		#else
			return value;
