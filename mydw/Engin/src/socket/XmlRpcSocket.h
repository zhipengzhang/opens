...
namespace XmlRpc {
  ...
  public:
    ...
    //! Read text from the specified socket(more times). Returns false on error.
    static bool nbRead(int socket, std::string& s, bool *eof);
	
	//! Read text from the specified socket(only a time). Returns false on error.
	static bool Read(int socket,std::string& s,bool*eof);
